# AgentPV Component 3 — PV `pytorch_fp32` evaluation summary

- **Variant**: `pytorch_fp32`
- **Model artefact**: `C:\Users\Mansycc\Desktop\omar\quantization\artifacts\cnn1d_pv_best.weights.pt`
- **Split**: `test`
- **Samples**: 4211
- **Classes**: 7
...
- p95: **1.014 ms** ✅ ≤ 100 ms
- p99: 3.289 ms
- min / max: 0.371 ms / 39.636 ms

## Model size

- File: `C:\Users\Mansycc\Desktop\omar\quantization\artifacts\cnn1d_pv_best.weights.pt`
- Size: 188.45 KiB (0.1840 MiB)
